...
const CryptoWalletDashboard = () => {
  ...
  // KYC status
  const kycStatus = "pending"; // 'pending', 'verified', 'incomplete'
  ...
  return (
    <Box minHeight="100vh" position="relative">
      ...
      >
        <HStack spacing={2}>
          ...
          <VStack spacing={0} alignItems="flex-start">
            ...
            <Badge colorScheme={kycStatus === "verified" ? "green" : "yellow"}>
      ...
      >
        ...
        <VStack
          spacing={1}
          opacity={activeNavItem === "activity" ? 1 : 0.7}
          onClick={() => setActiveNavItem("activity")}
        >
          <Icon
            as={FiActivity}
            fontSize="xl"
            color={activeNavItem === "activity" ? primaryColor : mutedTextColor}
          />
          <Text
            fontSize="xs"
            fontWeight={activeNavItem === "activity" ? "bold" : "normal"}
            color={activeNavItem === "activity" ? primaryColor : mutedTextColor}
          >
            Activity
          </Text>
        ...
        >
          <Icon
            as={FiSettings}
            fontSize="xl"
            color={activeNavItem === "settings" ? primaryColor : mutedTextColor}
          />
          <Text
            fontSize="xs"
        ...
        <VStack
          spacing={1}
          opacity={activeNavItem === "profile" ? 1 : 0.7}
          onClick={() => setActiveNavItem("profile")}
        >
          <Icon
            as={FiUser}
            fontSize="xl"
            color={activeNavItem === "profile" ? primaryColor : mutedTextColor}
          />
          <Text
            fontSize="xs"
            fontWeight={activeNavItem === "profile" ? "bold" : "normal"}
            color={activeNavItem === "profile" ? primaryColor : mutedTextColor}
          >
            Profile
          </Text>
